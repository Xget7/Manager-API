...
export const GetDeviceById = async (req: express.Request, res: express.Response) => {
     try {
...
export const GetDevicesByStoreId = async (req: express.Request, res: express.Response) => {
     try {
...
export const CreateDevice = async (req: express.Request, res: express.Response) => {
     try {
